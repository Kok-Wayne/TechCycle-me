<?php
    ...
    // Insert notification 
    // senderID   = worker   (who collected the product and sending notification to user indirectly)
    // receiverID = user     (who submitted the product and receiving notification from worker for e-waste collection status)
    $title   = $productName;
