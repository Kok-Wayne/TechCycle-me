...
<head>
    ...
    <title>Send Your E-Waste Material Location - TechCycle</title>
    ...
    <div class="container">
        ...
        <main>
            <section class="form-section">
                <h1>Send E-Waste Materials Location</h1>
                <form id="ewaste-form" class="form">
                    <div id="form-feedback" class="muted" style="text-align: center; margin-bottom: 1rem;"></div> 

                    <label>Item Name:</label>
                    <input type="text" name="item_name" required placeholder="e.g., Old Laptop, Broken Monitor">
                    ...
                    <textarea id="item-description" name="item-description" rows="3" required placeholder="Briefly describe the item-description and any known issues."></textarea>

                    <label for="category">Category:</label>
                    <select id="category" name="item-category" required>
                    ...
                    <button type="submit" class="button primary">Submit Location</button>
                    <p id="locationMsg"></p>
                </form>
            </section>
        </main>
